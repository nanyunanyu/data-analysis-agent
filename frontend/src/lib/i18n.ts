...
export const appCopy = {
  zh: {
    ...
    error: {
      ...
      backendOffline: '无法连接到后端服务。请确认已在 backend 目录运行 uvicorn main:app --reload --port 8003，或前端 VITE_BACKEND_PORT / VITE_BACKEND_URL 配置正确。',
      unknown: '未知错误',
  ...
  en: {
    ...
    error: {
      ...
      backendOffline: 'Cannot connect to the backend service. Run uvicorn main:app --reload --port 8003 in the backend directory, or check the frontend VITE_BACKEND_PORT / VITE_BACKEND_URL setting.',
